                    ...
                    <div className="content-form">
                        <form className="forms" id="form-message" onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
                            ...
                            <div className="group-input" id="group-input-groupe">
                                ...
                                <select name="groupe" id="select-groupe" reff='select-groupe' className="form-select" {...register("groupe")} multiple>
                            ...
                            <div className="group-input" id="group-input-contact">
                                ...
                                <select name="contact" id="select-contact" reff='select-contact' className="form-select" {...register("contact")} multiple>
