        ...
        <div class="p-5">
          <div class="px-8 bg-white shadow mt-24">
            ...
            <div class="mt-20 text-center border-b pb-12">
              ...
              <h2 class="text-2xl font-light text-gray-700 mt-3">
                Jessica.jones@gmail.com
              </h2>
              <h4 class="text-2xl font-light text-gray-700 mt-3">
                +2250702030105
              </h4>
              <p class="font-light text-gray-600 mt-3">Créateur de compte</p>
              <p class="mt-8 font-light text-gray-600">
                Type d'entreprise :{" "}
                <span class="font-medium text-gray-800 mt-3">Privé</span>
              </p>
              <p class="mt-2 font-light text-gray-600">
                Cannaux de diffusion :{" "}
              </p>
            </div>
