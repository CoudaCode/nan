...
function Map() {
  return (
    <div className="Map container my-12 py-12 mx-auto px-4 md:px-6 lg:px-14 Map">
      <section className="mb-20 text-gray-800">
        <h2 className="text-3xl font-bold text-center mb-4">
          Contactez-Nous...
        </h2>
        <div className="md:flex md:flex-wrap">
          <div className="xl:w-6/12 md:w-7/12 mb-6 lg:mb-0 md:pr-5 map" >
            <iframe
            ...
            <div className="grid xl:grid-cols-2 xl:grid-rows-2 xl:gap-x-4 md:gap-x-6">
              <div className="mb-1 md:mb-3">
                <div className="flex items-start">
                  <div className="shrink-0">
                    <div className="p-2 rounded-md w-12 h-12 flex items-center justify-center Icon">
                      <FaPhone />
                    </div>
                  </div>
                  <div className="element">
                    <h3 className="font-bold mb-1 text-white">Télephone</h3>
              ...
              <div className="mb-1 md:mb-12">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold mb-1 text-white top">Adresse Email</h3>
              ...
              <div className="mb-1 md:mb-12">
                <div className="flex align-start">
                  ...
                  <div>
                    <h3 className="font-bold mb-1 text-white top">Adresse</h3>
              ...
              <div className="mb-4 md:mb-4">
                <div className="flex align-start">
                  ...
                  <div>
                    <h3 className="font-bold mb-0.5 text-white top">
                      Temps de travail
                    </h3>
